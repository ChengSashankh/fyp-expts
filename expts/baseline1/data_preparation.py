...
# Parse arrays in string form to data structure
def str_to_arr(eqns):
  i = 0
...
# Anonymize variables in tokenized equations
...
pickle.dump(con_trim_flags, open('con_trim_flags.pkl', 'wb'))
pickle.dump(cons, open('cons.pkl', 'wb'))
pickle.dump(tkn, open('tkn.pkl', 'wb'))
