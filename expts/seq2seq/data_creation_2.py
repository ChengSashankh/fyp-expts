...
latex_math_symbol_macros = set(
    ['Alpha', 'alpha', 'Nu', 'nu', 'Beta', 'beta', 'Xi', 'xi', 'Gamma', 'gamma', 'Omicron', 'omicron', 'Delta', 'delta',
     'Pi', 'pi', 'var', 'Epsilon', 'epsilon', 'varepsilon', 'Rho', 'rho', 'varrho', 'Zeta', 'zeta', 'Sigma', 'sigma',
     'varsigma', 'Eta', 'eta', 'Tau', 'tau', 'Theta', 'theta', 'vartheta', 'Upsilon', 'upsilon', 'Iota', 'iota', 'Phi',
     'phi', 'varphi', 'Kappa', 'kappa', 'varkappa', 'Chi', 'chi', 'Lambda', 'lambda', 'Psi', 'psi', 'Mu', 'mu', 'Omega',
     'omega'])
...
threshold = 100
ip_thresh = 450
shorter_indices = [i for i, conlen in enumerate(op_seq_lengths) if (
            (conlen < threshold) and (len(op_wordLists[i]) > 0) and not (
                len(op_wordLists[i]) == 1 and op_wordLists[i][0] == 'nan'))]
